...
import com.example.PaySathi.services.InsightsService;
...
public class InsightsController {
    ...
    public ResponseEntity<CustomerSummaryResponse> getCustomerSummary(
        ...
        return ResponseEntity.ok(insightsService.getCustomerSummary(externalId));
    }
    ...
    public ResponseEntity<CustomerCreditResponse> getCustomerCreditProfile(
        ...
        return ResponseEntity.ok(insightsService.getCustomerCreditProfile(externalId));
    }
    ...
    public ResponseEntity<List<CustomerSummaryResponse>> getAllCustomerSummaries() {
        ...
        return ResponseEntity.ok(insightsService.getAllCustomerSummaries());
    }
    ...
    public ResponseEntity<List<OverdueInvoiceResponse>> getAllOverdueInvoices() {
        ...
        return ResponseEntity.ok(insightsService.getAllOverdueInvoices());
    }
}